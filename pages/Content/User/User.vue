<template>
  <scroll-view :style="{'height':windowHeight+'px'}" scroll-y="true" :scroll-top="scrollTop" @scroll="scroll"
    ...
    <view class="full">
      <view class="header">
        <view class="setting">
          <image style="width:48upx;height:48upx" src="../../../static/img/back.png" mode="aspectFill"
            @click.stop="navBack"></image>
        </view>
      ...
      <view class="info solid-bottom" style="margin-bottom:20upx">
        <view v-if="!attentionShow && objectId!=myObjectId" @click="attention" class="attention-active text-white"><text
            class="cuIcon-add"></text> 关注</view>
        ...
        if (queryObject.userInfo === true) {
          ...
          query.get(this.objectId).then(res => {
            ...
            if (this.userInfo.birthday) {
              ...
              this.userInfo.constellation = this.getAstro(this.userInfo.birthday.slice(5, 7), this.userInfo.birthday
                .slice(8, 10))
            }
