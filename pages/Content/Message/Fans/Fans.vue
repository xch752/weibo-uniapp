<template>
  <view>
    <uni-nav-bar left-icon="back" @click-left="navBack" :status-bar="true" shadow="true" fixed="true" title="粉丝">
    </uni-nav-bar>
    <scroll-view v-if="fansList.length === 0?false:true" :style="{'height':windowHeight+'px'}"
    ...
    <view v-if="fansList.length === 0?true:false" class="flex justify-center align-center"
