    ...
    <scroll-view v-if="likesList.length === 0?false:true" :style="{'height':windowHeight+'px'}"
      ...
      <view class="cu-list menu-avatar">
        <view class="cu-item" v-for="(item,index) in likesList" :key="index"
          @click="toMicroBlog(item.liked_blog.objectId)">
          ...
          <view class="action">
            <view class="blog-img" :style="{'background-image':'url('+item.liked_blog.imgList.split(',')[0]+')'}">
            </view>
          </view>
        </view>
      </view>
    </scroll-view>
    <view v-if="likesList.length === 0?true:false" class="flex justify-center align-center"
